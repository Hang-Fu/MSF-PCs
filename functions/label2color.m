...
switch lower(data_name)
    ...
    case 'houston'
        map=[0, 205, 0;127, 255, 0;46, 139, 87;0, 139, 0;160, 82, 45;0, 255, 255;255, 255, 255; 216, 191, 216;255, 0, 0;139, 0, 0;51,102,255;255, 255, 0;238, 154, 0;85, 26, 139;255, 127, 80];
        for i=1:w
            for j=1:h
                switch(label(i,j))
                    case(1)
